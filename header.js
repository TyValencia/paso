...
firebase.auth().onAuthStateChanged(function(user) {
    ...
    if (user) {
        ...
        buttonContainer.innerHTML = `
            <button id="homeownerButton" class="header-button" onclick="location.href='homeowner.html'">Register your home</button>
            <button id="preferencesButton" class="header-button" onclick="location.href='preferences.html'">Update preferences</button>
        `;
    } else {
        // No user is signed in, replace the Update Your Preferences button with the Sign In and Sign Up buttons
        buttonContainer.innerHTML = `
            <button id="signinButton" class="header-button" onclick="location.href='signin.html'">SIGN IN</button>
            <button id="signupButton" class="header-button" onclick="location.href='signup.html'">SIGN UP</button>
        `;
    }
});